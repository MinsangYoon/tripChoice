...
function init () {
	...
	th_cost3 = document.form.th_cost3.value;
	thr_baby = document.form.thr_baby.value;
...
function add () {
	...
	sum3.value = parseInt(hm3.value) * parseInt(th_cost3);
	thr_price.value=parseInt(sum1.value)+parseInt(sum2.value)+parseInt(sum3.value);
}
function add2 () {
	hm = document.form.thr_adult;
	hm2 = document.form.thr_kid;
...
<form name="form" method="post" action="${root}/hotel_reser/hotel_reser_insert.do">
	<!--
	...
	<tr>
		...
		<input type="text" name="thr_adult" value="0" size="3" onchange="change();">
		<input type="button" value=" + " onclick="add();"><input type="button" value=" - " onclick="del();"></td>
	</tr>
	<tr>
		<td width="100px" height="100px" style="text-align: center;">청소년<br><span style="font-weight: bold;">${dto.th_cost2}원</span></td> 
		<td width="200px;"><input type=hidden name="th_cost2" value="${dto.th_cost2}">
		<input type="text" name="thr_kid" value="0" size="3" onchange="change2();">
		<input type="button" value=" + " onclick="add2();"><input type="button" value=" - " onclick="del2();"></td>
	</tr>
	<tr>
		<td width="100px" height="100px" style="text-align: center;">유아<br><span style="font-weight: bold;">${dto.th_cost3}원</span></td> 
		<td width="200px;"><input type=hidden name="th_cost3" value="${dto.th_cost3}">
		<input type="text" name="thr_baby" value="0" size="3" onchange="change3();">
	...
	<tr>
		<td>체크인 날짜</td>
		<td><input type="text" name="thr_in" id="thr_in" value="체크인" ></td>
	</tr>
	<tr>
		<td>체크아웃 날짜</td>
		<td><input type="text" name="thr_out" id="thr_out" value="체크아웃"></td>
	</tr>
	</table>
