...
<form name="hotel_reser" method="post" action="${root}/hotel_reser/hotel_reser_insert.do">
	...
	-->
	<input type="hidden" id="trip_code" name="trip_code" value="${trip_code}"> 
	<input type="hidden" id="th_code" name="th_code" value="${dto.th_code}"> 
	<input type="hidden" id="tr_adult" name="tr_adult" value="${tr_adult}">
	<input type="hidden" id="tr_kid" name="tr_kid" value="${tr_kid}">
	<input type="hidden" id="tr_baby" name="tr_baby" value="${tr_baby}">
	<input type="hidden" id="tr_price" name="tr_price" value="${tr_price}">
	<input type="hidden" id="tr_departure" name="tr_departure" value="${tr_departure}">
	<input type="hidden" id="tr_arrival" name="tr_arrival" value="${tr_arrival}">
